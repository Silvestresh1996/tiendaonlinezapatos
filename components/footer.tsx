...
const benefits = [
  {
    icon: Truck,
    title: "Envio Gratis",
    description: "En compras mayores a $499 MXN",
  },
  {
    icon: CreditCard,
    title: "Pago Seguro",
  ...
  },
  {
    ...
    description: "Garantia de autenticidad",
  },
  {
    icon: RefreshCw,
    title: "Devoluciones",
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-8 h-8 rounded-full bg-foreground/10 flex items-center justify-center hover:bg-accent hover:text-accent-foreground transition-colors"
          ...
          <div>
            <h3 className="font-bold text-foreground mb-4">Tienda</h3>
